  ...
  <section className="RecommendedArticles" style={style}>
    ...
    {heading && (
      <header style={styles.header}>
        <Heading level={2} weight="thin" override={styles.heading}>
          {heading}
        </Heading>
      </header>
    )}
    ...
    {calloutLabel && calloutHref && (
      <footer style={styles.footer}>
        <CalloutLink href={calloutHref}>{calloutLabel}</CalloutLink>
      </footer>
    )}
  </section>
);

CreatedArticles.propTypes = {
...
export default radium(CreatedArticles);
